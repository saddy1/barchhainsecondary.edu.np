{{-- resources/views/pages/academics-elementary.blade.php --}}
@extends('layouts.app')

@php($page = __('site.academics.elementary'))

@section('title', $page['title'])
@section('meta_description', $page['hero_sub'])
@section('meta_keywords', 'Barchhain Secondary School, early childhood education, basic education Doti, government school')
...
<script type="application/ld+json">
{
    ...
    "url": "{{ route('academics.elementary') }}"
}
</script>
@endsection
    ...
    <div class="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid gap-12 lg:grid-cols-[1fr_.8fr] lg:items-center">
            ...
            <div class="rounded-[2rem] border-4 border-white/10 bg-white/5 p-3 shadow-2xl">
                <img src="{{ $siteSettings->imageUrl('academics_elementary_image', 'assets/image/kids.jpg') }}" alt="{{ $page['h1'] }}" class="h-[320px] w-full rounded-[1.5rem] object-cover">
            </div>
        </div>
    </div>
</section>
